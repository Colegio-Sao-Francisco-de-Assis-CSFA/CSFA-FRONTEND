import HeroBannerCarousel from '@/components/site/HeroBanner';
import Segmentos from '@/components/site/Segmentos';
import SobreColegio from '@/components/site/SobreColegio';
import MissaoColegio from '@/components/site/MissaoColegio';
import Parceiros from '@/components/site/Parceiros/SessaoParceiros';
