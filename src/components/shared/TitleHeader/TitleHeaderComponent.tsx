...
import { Button as LinkButton } from '@/components/shared/Button';
...
const TitleHeaderComponent: React.FC<TitleProps> = ({
    ...
    if (variant === 'hero') {
        return (
            <div className={`${currentAlignment.container}`}>
    ...
    if (variant === 'missao') {
        return (
            <div className={`mb-12 ${currentAlignment.container}`}>
                <motion.h2
                    className={`text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 max-w-5xl mx-auto ${currentColor.title}`}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 0.2 }}
                >
                ...
                <motion.p
                    className={`text-lg md:text-4xl leading-relaxed max-w-3xl mb-8 ${currentAlignment.subtitle} ${currentColor.tagline}`}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 0.4 }}
                >
