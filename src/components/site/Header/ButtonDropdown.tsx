  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="w-36 h-full p-2 bg-blue-600 hover:bg-blue-800 cursor-pointer text-white border border-gray-200 shadow-md hover:shadow-lg transition-all duration-200 rounded-lg px-4 py-2">
