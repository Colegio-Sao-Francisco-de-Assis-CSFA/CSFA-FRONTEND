...
export default function Sobre() {
  ...
  return (
    <div className='w-screen h-dvh'>
      ...
      <main className="flex flex-col w-full h-auto bg-slate-800">
        {/* Hero Banner */}
        <header className="relative h-[50vh] w-full overflow-hidden">
          <div className="absolute inset-0 bg-black/50 z-10" />
          <div className="absolute inset-0 bg-[url('/placeholder.png')] bg-cover bg-center" style={{ backgroundPosition: "center 30%" }} />
          <motion.div 
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/2">
                ...
                <div className="space-y-4 text-slate-300">
                  <p>Fundada em 2010, nossa empresa nasceu da visão de profissionais apaixonados por inovação e tecnologia, determinados a criar soluções que fazem a diferença para nossos clientes.</p>
                  <p>Começamos como uma pequena equipe em um escritório modesto, mas com grandes ambições. Ao longo dos anos, expandimos nossa presença no mercado, mantendo nosso compromisso com a excelência.</p>
                  <p>Hoje, somos reconhecidos como líderes em nosso segmento, com uma carteira diversificada de clientes e projetos bem-sucedidos.</p>
                </div>
              </div>
              <div className="md:w-1/2">
                <motion.div 
                ...
                >
                  <div className="absolute inset-0 bg-[url('/placeholder.png')] bg-cover bg-center rounded-lg" />
                </motion.div>
              </div>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {['Missão', 'Visão', 'Valores'].map((item, index) => {
                ...
                const descriptions = [
                  "Desenvolver soluções inovadoras que otimizem processos, impulsionem negócios e contribuam para um futuro mais sustentável.",
                  "Ser referência global em inovação e excelência, reconhecida pela capacidade de transformar desafios em oportunidades.",
                  "Integridade, excelência, inovação, colaboração, sustentabilidade e foco no cliente são os pilares que orientam nossas ações."
                ];
                  ...
                  <motion.div key={index} variants={fadeIn} className="h-full">
                    <Card className="h-full bg-slate-900 border-slate-700 hover:border-blue-600 transition-all duration-300">
                      <CardContent className="pt-6">
                        ...
                        <h3 className="text-xl font-bold text-white text-center mb-4">{item}</h3>
                        <p className="text-slate-300 text-center">{descriptions[index]}</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                );
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-slate-300 max-w-2xl mx-auto">
                Conheça os profissionais talentosos e dedicados que compõem nossa equipe e trabalham para entregar resultados excepcionais.
              </p>
            </div>
              ...
              {differentials.map((item, index) => (
                ...
                >
                  <div className="flex items-start mb-4">
                    <div className="p-3 bg-blue-600/20 rounded-lg mr-4 flex-shrink-0">
          ...
          >
            <div className="bg-blue-600 rounded-lg p-8 md:p-12 text-center">
              ...
              <p className="text-white/90 mb-6 max-w-2xl mx-auto">
                Entre em contato conosco hoje mesmo para discutir como podemos ajudar sua empresa a alcançar novos patamares.
              </p>
